# -*- coding: utf-8 -*-
"""
Created on Thu Mar 16 17:28:00 2017

@author: ASY

Google Inception Net V3实现
    ...
    with tf.variable_scope(scope, 'inceptionV3', [inputs]):
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride = 1, padding = 'SAME'):
            ...
            with tf.variable_scope('Mixed_5c'):
                ...
                with tf.variable_scope('Brach_2'):
                    branch_2 = slim.conv2d(net, 64, [1,1], scope = 'Conv2d_0a_1x1')
            ...
            with tf.variable_scope('Mixed_6a'):
                '''
                开始第二个模块组,第一个Inception Module
                '''
                with tf.variable_scope('Branch_0'):
                    branch_0 = slim.conv2d(net, 384, [3,3], sride = 2, padding = 'VALID', scope = 'Conv2d_1a_1x1')
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net, 64, [1,1], scope = 'Conv2d_0a_1x1')
                    branch_1 = slim.conv2d(branch_1, 96, [3,3], scope = 'Convd_0b_3x3')
            ...
            with tf.variable_scope('Mixed_7a'):
                '''
                第三个Module组开始,第一个Inception Module
                '''
                with tf.variable_scope('Branch_0'):
                    branch_0 = slim.conv2d(net, 192, [1,1], scope = 'Conv2d_0a_1x1')
...
def inception_v3(inputs, 
    ...
    with tf.variable_scope('Logits'):
        net = slim.avg_pool2d(net, [8, 8], padding = 'VAILD', scope = 'AvgPool_1a_8x8')
